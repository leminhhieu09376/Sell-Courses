...
import { AiOutlineShoppingCart, AiOutlineGlobal, AiFillCreditCard, AiFillCheckCircle, AiFillStepBackward, AiFillHome } from 'react-icons/ai';
            ...
            </div>
            {
                onCheck === false ?
                    ...
                    <div className='w-full mt-20 h-96'>
                        ...
                        <div className='mx-auto w-96 h-32 bg-[#c0e5df] text-left flex '>
                            <div className='mt-3 ml-4 mr-4'>
                                <AiFillCheckCircle className='h-10 w-10' />
                            </div>
                            <div className='mt-3'>
                                <h3 className='font-bold'>Successful purchase</h3>
                                <p className='text-sm'>Thank you for purchasing our online course. We highly appreciate your support.</p>
                        ...
                        <div onClick={() => {
                            ...
                            className=" cursor-pointer w-96 border outline-none mb-4 p-3 font-bold bg-[#ACD2CC] text-white flex justify-center items-center mx-auto"

                        >
                            <AiFillHome className='text-black' />
                            <p className='text-black font-bold'>Back to Homepage</p>
                        </div>
                    </div>
            }
